...
module.exports = {
    name: 'bem870',
    cooldown: 30,
    aliases: ['beremingtonmodelm870', 'beremingtonm870', 'best ergo m870'],
    ...
    execute(message, args) {
        const Embed = {
            ...
            fields: [{
                ...
                {
                    name: '**Mod List**',
                    value: (config.topTable + config.leo + config.hogue + config.prsgen3 + config.m870325 + config.moem870 + config.mlok4 + config.fortisg + config.endTable),
                },
            ],
            footer: {
